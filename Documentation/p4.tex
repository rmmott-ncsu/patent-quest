...
\begin{figure}[H]
\includegraphics[width=13cm, height=3cm]{exp1_result}
\centering
...
\begin{figure}[H]
\includegraphics[width=12cm, height=3cm]{exp2_result}
\centering
...
\begin{figure}[H]
\includegraphics[width=7cm, height=4cm]{exp3_result}
\centering
\caption{Graph of accuracy convergence using NB Model}
